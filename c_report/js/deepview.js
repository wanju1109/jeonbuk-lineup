...
const DeepView = (() => {
  ...
  const ROLE_GLOSSARY = [
    ...
    },
    {
      ...
      items: [
        {
          term: "센터백",
          desc: "수비 라인 중앙. 상대 공격을 막고 공을 걷어내거나, 짧은 패스로 빌드업을 시작합니다.",
        },
        {
          term: "전진형 센터백",
          desc: "일반 센터백보다 전진해 압박하거나 패스 라인을 앞당기는 역할. 팀이 높은 수비 라인을 유지할 때 자주 보입니다.",
        },
        {
          term: "풀백",
          desc: "측면 수비수. 상대 윙을 막고, 필요할 때 측면으로 전진해 크로스·겹치기를 지원합니다. (왼쪽/오른쪽)",
        },
        {
          term: "공격형 풀백",
          desc: "풀백이지만 공격 3분면까지 자주 올라가 크로스·컷백을 만드는 역할. (왼쪽/오른쪽)",
        },
      ],
    },
    {
      ...
      items: [
        {
          term: "홀딩 미드필더",
          desc: "수비 앞에서 공을 받아 전개하거나, 상대 공격을 끊는 거점. 패스 안정성과 수비 커버가 핵심입니다.",
        },
        {
          term: "딥라잉 플레이메이커",
          desc: "수비 라인 앞 깊은 자리에서 공을 받아 전방으로 키패스·전진 패스를 연결하는 역할입니다.",
        },
        {
          term: "중앙 미드필더",
          desc: "중앙에서 공을 연결하며 템포를 조절. 공격과 수비 사이를 오가는 허브 역할입니다.",
        },
        {
          term: "박스 투 박스",
          desc: "수비 박스부터 상대 박스까지 넓게 뛰며 압박·전환·2선 공격을 모두 수행합니다.",
        },
        {
          term: "미드필더",
        ...
        {
          term: "공격형 미드필더",
          desc: "중앙에서 더 앞쪽에 위치해 마지막 패스·침투·슈팅을 만듭니다.",
        },
        {
          term: "윙어",
          desc: "측면에서 볼을 잡고 돌파·크로스·컷인을 시도합니다. (왼쪽/오른쪽)",
        },
        {
          term: "인사이드 윙어",
          desc: "측면에서 시작해 안쪽으로 침투해 슈팅·키패스를 만드는 역할. (왼쪽/오른쪽)",
        },
        {
          term: "하프스페이스 공격형 MF",
          desc: "골문과 측면 사이 하프스페이스에서 받아 침투·연결하는 역할. (왼쪽/오른쪽)",
        },
      ],
    },
    {
      ...
      items: [
        {
          term: "최전방 스트라이커",
          desc: "가장 앞에서 상대 수비 라인을 붙잡고, 박스 안 마무리·1차 압박을 담당합니다.",
        },
        {
          term: "처진 스트라이커",
          desc: "공격수지만 중앙 미드와 스트라이커 사이에서 연결·전환·2선 슈팅을 만듭니다.",
        },
        {
          term: "윙 포워드",
  ...
  function renderRoleGlossary() {
    ...
    box.dataset.ready = "1";
    box.innerHTML =
      `<div class="dd-role-glossary-head">` +
      `<h4 class="dd-role-glossary-title">역할 이름 가이드</h4>` +
      `<p class="dd-role-glossary-lead">카드에 붙는 역할은 평균 위치와 행동 지표에서 자동 추정한 이름입니다. 등록 포지션과 다를 수 있습니다.</p>` +
      `</div>` +
