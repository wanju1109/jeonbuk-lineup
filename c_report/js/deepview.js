...
const DeepView = (() => {
  ...
  function renderShapes(ctx) {
    ...
    drawShape("ddHomeShape", ctx.home, pal("home").pitch);
    drawShape("ddAwayShape", ctx.away, pal("away").pitch);
  ...
  function renderRoles(ctx) {
    ...
    box.innerHTML = list.length
      ? list.map((p) => roleCard(p, roleSide)).join("")
  ...
  function redrawCanvases() {
    ...
    drawShape("ddHomeShape", currentCtx.home, pal("home").pitch);
    drawShape("ddAwayShape", currentCtx.away, pal("away").pitch);
