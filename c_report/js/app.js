...
(() => {
  ...
  function buildShareHtml(url) {
    ...
    return [
      '<table cellpadding="0" cellspacing="0" border="0" bgcolor="#0f2a1c" width="560" style="max-width:560px;width:100%;border-collapse:collapse;background-color:#0f2a1c;color:#f5fff8;font-family:Arial,Helvetica,sans-serif;">',
