...
(() => {
  ...
  function buildShareHtml(url) {
    ...
    return [
      '<p style="max-width:560px;margin:0 0 14px;font-size:14px;line-height:1.75;color:#222;font-family:Arial,sans-serif;">',
      ...
      `<div style="font-size:12px;letter-spacing:.06em;opacity:.75;margin-bottom:6px;">JEONBUK MATCH AI REPORT</div>`,
