...
document.querySelector('#embed-code').value=`<iframe src="${url.href}" title="축구 취향 테스트 · 단장, 팬, 축구 스타일" width="100%" height="800" style="border:0;border-radius:16px" loading="lazy" allow="clipboard-write"></iframe>`;
