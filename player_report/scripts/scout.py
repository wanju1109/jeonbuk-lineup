...
CURATED = {
    "20180025": {
        "profile": (
            "송범근은 K리그1에서 보기 드문, 한 클럽의 골문을 거의 십 년에 가깝게 "
            "지켜 온 전북 현대의 상징적인 골키퍼다. 1997년생, 194cm/88kg의 프레임은 "
            "박스 안에서 존재감 그 자체고, 2018 프로 데뷔 이후 전북 유니폼만 입고 "
            "성장한 원클럽맨에 가깝다. 공식 기록상 K리그1 출장이 200경기를 훌쩍 "
            "넘고, 클린시트도 세 자릿수에 들어간다. 숫자만 봐도 ‘가끔 나서는 백업’이 "
            "아니라 한 시대의 1순위 키퍼라는 뜻이다. 군 복무로 비는 시즌이 있어도 "
            "복귀 후 바로 주전 장갑을 다시 끼는 무게가 있다. 큰 경기, 원정, "
        ...
        "weaknesses": (
            ...
            "노출된다. 원클럽으로 오래 뛴 선수에게 따라붙는 또 하나의 숙제는 "
            ...
            "포인트다. 그리고 군 복무 공백처럼 시즌이 비면 경기 감각을 되돌리는 "
            "초반 몇 경기가 늘 과제로 남는다."
        ),
    },
    "20220042": {
