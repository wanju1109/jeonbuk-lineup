...
const match = {date:'2026-09-15',time:'19:00'};
const research = {...p,version:'chronological-v2',generated_at:'2026-09-15T18:00:00+09:00'};
assert.ok(display.researchForecast(match,research));
assert.equal(display.researchForecast(match,{...research,generated_at:'2026-09-15T20:00:00+09:00'}),null);
